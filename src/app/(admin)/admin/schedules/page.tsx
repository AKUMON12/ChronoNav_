...
const INITIAL_MASTER_SCHEDULES: (ClassScheduleItem & { program: string; yearLevel: string; schedCode?: string })[] = [
  // ── Official UC Study Load PDF Offerings (BSIT 4 / Vince Andrew Santoya Load) ──
  {
    id: "pdf-sched-1",
    courseCode: "LIT 101",
