    ...
    <div className="space-y-8 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#507495]/20 pb-5">
        ...
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 rounded-xl bg-indigo-500/10 border border-indigo-500/30 px-3.5 py-1.5 text-xs font-black text-indigo-400">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-3xl border border-[#507495]/20 bg-[#141E28] p-5 space-y-1 shadow-sm">
          <span className="text-[10px] font-black text-[#74777E] uppercase tracking-wider block">
            ASSIGNED SECTIONS
          </span>
          <p className="text-2xl font-black text-white">3 Teaching Loads</p>
        </div>
        ...
        <div className="rounded-3xl border border-[#507495]/20 bg-[#141E28] p-5 space-y-1 shadow-sm">
          ...
          <p className="text-2xl font-black text-indigo-400">115 Students</p>
        </div>
        ...
        <div className="rounded-3xl border border-[#507495]/20 bg-[#141E28] p-5 space-y-1 shadow-sm">
          ...
          <p className="text-sm font-black text-white truncate">CCS Faculty Room 205 (2F)</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {facultyTeachingSchedule.map((item) => (
            <div
              key={item.id}
              className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-3xl border border-[#507495]/20 bg-[#141E28] p-5 hover:border-indigo-500/40 shadow-sm transition-all"
            >
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-black bg-indigo-500/20 text-indigo-400 px-2 py-0.5 rounded-md">
                    {item.courseCode}
                  </span>
                ...
                <h3 className="text-base font-black text-white">{item.courseTitle}</h3>

                <div className="flex flex-wrap items-center gap-3 text-xs text-[#74777E]">
