...
/**
 * NotificationsSkeleton - Skeletal placeholder UI for campus announcements & alerts.
 */
export function NotificationsSkeleton() {
  return (
    <div className="space-y-6 sm:space-y-8 p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto w-full animate-in fade-in duration-300">
      {/* Header Skeleton */}
